...
from SisAero.celery import VERSION_BANNER, platforms, signals
from SisAero.celery import trace
from SisAero.celery import AppLoader
from SisAero.celery import EX_FAILURE, EX_OK, check_privileges
from SisAero.celery import static, term
from SisAero.celery import cry
from SisAero.celery import qualname
from SisAero.celery import get_logger, in_sighandler, set_in_sighandler
from SisAero.celery import pluralize
from SisAero.celery import WorkController
...
def _shutdown_handler(worker, sig='TERM', how='Warm',
    ...
    def _handle_request(*args):
        with in_sighandler():
            from SisAero.celery import state
...
def install_rdb_handler(envvar='CELERY_RDBSIG',
    ...
    def rdb_handler(*args):
        ...
        with in_sighandler():
            from SisAero.celery import _frame, set_trace
