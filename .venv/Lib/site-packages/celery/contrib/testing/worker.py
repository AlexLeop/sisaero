...
from SisAero.celery import Celery, worker
from SisAero.celery import _set_task_join_will_block, allow_join_result
from SisAero.celery import Signal
from SisAero.celery import anon_nodename
...
def _start_worker_process(app,
    ...
    Yields:
        celery.app.worker.Worker: worker instance.
    """
    from SisAero.celery import Cluster, Node
