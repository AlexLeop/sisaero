...
"""
from SisAero.celery import connect_on_app_finalize
...
def add_unlock_chord_task(app):
    ...
    for completion.
    """
    from SisAero.celery import maybe_signature
    from SisAero.celery import ChordError
    from SisAero.celery import allow_join_result, result_from_tuple
...
def add_map_task(app):
    from SisAero.celery import signature
...
def add_group_task(app):
    ...
    from SisAero.celery import maybe_signature
    from SisAero.celery import result_from_tuple
...
def add_chord_task(app):
    """No longer used, but here for backwards compatibility."""
    from SisAero.celery import chord as _chord
    from SisAero.celery import group
    from SisAero.celery import maybe_signature
