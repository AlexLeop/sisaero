"""Celery Application."""
from SisAero.celery import _state
from SisAero.celery import app_or_default, disable_trace, enable_trace, pop_current_task, push_current_task
from SisAero.celery import Proxy
...
def shared_task(*args, **kwargs):
    ...
    Example:
        ...
        >>> from SisAero.celery import Celery, shared_task
        >>> @shared_task
        ... def add(x, y):
        ...     return x + y
        ...
