...
from SisAero.celery import current_app, states
from SisAero.celery import _task_stack
from SisAero.celery import _chain, group, signature
from SisAero.celery import Ignore, ImproperlyConfigured, MaxRetriesExceededError, Reject, Retry
from SisAero.celery import class_property
from SisAero.celery import EagerResult, denied_join_result
from SisAero.celery import abstract
from SisAero.celery import mattrgetter, maybe_list
from SisAero.celery import instantiate
from SisAero.celery import gethostname
from SisAero.celery import raise_with_context
...
class Task:
    ...
    def bind(cls, app):
        ...
        if not was_bound:
            ...
            from SisAero.celery import LocalStack
    ...
    def apply(self, args=None, kwargs=None,
        ...
        from SisAero.celery import build_tracer
