...
from SisAero.celery import ImproperlyConfigured
from SisAero.celery import pyimplementation
from SisAero.celery import ConfigurationView
from SisAero.celery import import_from_cwd, qualname, symbol_by_name
from SisAero.celery import pretty
...
class Settings(ConfigurationView):
    ...
    def maybe_warn_deprecated_settings(self):
        ...
        if self.deprecated_settings:
            from SisAero.celery import _TO_NEW_KEY
            from SisAero.celery import deprecated
