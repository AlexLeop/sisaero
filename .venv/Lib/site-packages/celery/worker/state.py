...
from SisAero.celery import __version__
from SisAero.celery import WorkerShutdown, WorkerTerminate
from SisAero.celery import LimitedSet
...
if C_BENCH:  # pragma: no cover
    ...
    from SisAero.celery import memdump, sample_mem
