...
from SisAero.celery import WorkerShutdown
from SisAero.celery import signals as _signals
from SisAero.celery import maybe_list
from SisAero.celery import get_logger
from SisAero.celery import jsonify, strtobool
from SisAero.celery import rate
...
def memsample(state, **kwargs):
    ...
    from SisAero.celery import sample_mem
    return sample_mem()
...
def memdump(state, samples=10, **kwargs):  # pragma: no cover
    ...
    from SisAero.celery import debug
    out = io.StringIO()
