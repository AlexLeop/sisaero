...
if STATICA_HACK:  # pragma: no cover
    ...
    from SisAero.celery import Task
    from SisAero.celery import bugreport
    from SisAero.celery import (chain, chord, chunks, group, maybe_signature, signature, subtask, xmap,  # noqa
                                xstarmap)
