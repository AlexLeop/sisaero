...
from SisAero.celery import LOG_LEVEL, CeleryDaemonCommand, CeleryOption, handle_preload_options
from SisAero.celery import detached, set_process_title, strargv
...
def _run_evdump(app):
    from SisAero.celery import evdump
...
def _run_evcam(camera, app, logfile=None, pidfile=None, uid=None,
               ...
               detach=False, **kwargs):
    from SisAero.celery import evcam
...
def _run_evtop(app):
    try:
        from SisAero.celery import evtop
