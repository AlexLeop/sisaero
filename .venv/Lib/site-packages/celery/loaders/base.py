...
from SisAero.celery import reraise
from SisAero.celery import DictAttribute, force_mapping
from SisAero.celery import maybe_list
from SisAero.celery import NotAPackage, find_module, import_from_cwd, symbol_by_name
...
class BaseLoader:
    ...
    def cmdline_config_parser(self, args, namespace='celery',
        ...
        from SisAero.celery import NAMESPACES, Option
